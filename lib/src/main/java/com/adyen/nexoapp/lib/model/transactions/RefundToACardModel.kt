...
class RefundToACardModel(val application: Application,
                   val poiId: String,
                   val currency: String,
    ...
    override fun createTerminalRequest() : TerminalRequest {
        ...
        val paymentData = PaymentData("Refund")
        val paymentRequest = PaymentRequest(paymentTransaction, saleData, paymentData)
